...
## Part XXX — The Nodal Choice Interface: An Original W3BB Interpretive Framework Layered on the Real Node Decan Cards

### 30.1 — What is, and is not, new here
...
### 30.2 — Why this strengthens the Codex's own standing free-will framing, rather than adding a new claim
...
### 30.3 — The interface, exactly as specified
...
- For each card, a **Constructive expression** line and a **Possible imbalance** line — see §30.4 for exactly how these are derived.
...
### 30.4 — Constructive expression / Possible imbalance: derivation rule and honest scope
...
### 30.5 — Wiring: in-memory choice, additive framing, graceful default
